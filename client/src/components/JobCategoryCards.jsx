...
const CATEGORY_THEMES = {
  ...
  others: {
    icon: GraduationCap,
    gradient: 'bg-gradient-to-b from-[#334155] via-[#1e293b] to-[#0f172a]',
    border: 'border-slate-400/40 hover:border-slate-300',
    iconBg: 'bg-slate-400/25 text-slate-100 border border-slate-300/30',
    badgeBg: 'bg-slate-400/20 text-slate-100 border border-slate-300/30',
    glow: 'hover:shadow-[0_14px_32px_-6px_rgba(71,85,105,0.55)]',
    defaultSubtitle: 'Central Govt, Railway & SSC',
  },
  other: {
    icon: Building2,
    gradient: 'bg-gradient-to-b from-[#334155] via-[#1e293b] to-[#0f172a]',
    ...
    badgeBg: 'bg-slate-400/20 text-slate-100 border border-slate-300/30',
    glow: 'hover:shadow-[0_14px_32px_-6px_rgba(71,85,105,0.55)]',
    defaultSubtitle: 'Central Govt & Other Exams',
  },
  ssc: {
    icon: Landmark,
