...
import { latestAdmitCards as defaultAdmitCards } from '../data/seed.js'

export default function AdmitCardsCard({
  admitCards = defaultAdmitCards,
  viewAllTo = '/latest/admit-card',
}) {
  const items = admitCards.slice(0, 5)
