    ...
    <header className="fixed top-0 left-0 right-0 z-50 h-[72px] px-2 py-2 sm:px-4 sm:py-2.5 transition-all duration-300 bg-[#050814]/95 backdrop-blur-md">
      ...
      <div className="relative mx-auto flex h-full w-full max-w-[1600px] items-center justify-between gap-3 rounded-2xl px-3 sm:px-4 transition-all duration-300 bg-[#080d1e] border border-cyan-500/20 shadow-[0_0_20px_rgba(0,180,255,0.08)] backdrop-blur-2xl">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-2.5">
          {/* Quick Articles Button */}
          <Link
            to="/articles"
            className="group flex items-center gap-1.5 rounded-full px-3 py-2 transition-all shadow-sm bg-[#111628] text-slate-300 border border-white/10 hover:border-amber-400/40 hover:text-amber-300"
            title="Career Articles & Exam Guides"
          >
            <BookOpen size={16} className="transition-colors text-amber-400 group-hover:text-amber-300" />
            <span className="hidden text-xs font-bold md:inline">Articles</span>
          </Link>
